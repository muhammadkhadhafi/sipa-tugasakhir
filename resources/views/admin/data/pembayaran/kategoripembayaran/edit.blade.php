...
@section('container')
  ...
  <div class="card shadow mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h6 class="m-0 font-weight-bold text-primary text-uppercase">Edit Kategori Pembayaran</h6>
    </div>
    <div class="card-body">
      <form action="{{ url('admin/pembayaran/kategoripembayaran') }}/{{ $kategori->id }}" method="post">
        @csrf
        @method('put')
        <div class="row">
          <div class="col-lg-12">
            <div class="mb-3">
              ...
              <input type="text" name="kategori_pembayaran" id="kategori_pembayaran"
                ...
                value="{{ $kategori->kategori_pembayaran }}">
          ...
          <div class="col-lg-12">
            <div class="mb-3">
              ...
              <input type="number" name="harga" id="harga"
                class="form-control @error('harga') is-invalid @enderror" value="{{ $kategori->harga }}">
              @error('harga')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
