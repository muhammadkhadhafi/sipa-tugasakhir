...
@section('container')
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="{{ url('mahasiswa/pengajuansuratketeranganaktif', $pengajuan->id) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <select name="semester" id="semester" class="form-control @error('semester') is-invalid  @enderror">
                <option value="{{ $pengajuan->semester }}" selected>{{ $pengajuan->semester }}</option>
          ...
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <input type="number" name="no_hp" id="no_hp"
                class="form-control @error('no_hp') is-invalid @enderror" value="{{ $pengajuan->no_hp }}">
              @error('no_hp')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <input type="text" name="nama_orang_tua" id="nama_orang_tua"
                ...
                value="{{ $pengajuan->nama_orang_tua }}">
          ...
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <select name="pekerjaan_orang_tua" id="pekerjaan_orang_tua"
                ...
                <option value="{{ $pengajuan->pekerjaan_orang_tua }}" selected>{{ $pengajuan->pekerjaan_orang_tua }}
                </option>
